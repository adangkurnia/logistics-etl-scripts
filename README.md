...
## OBJECTIVES
**The Challenge:** Daily 3PL and fleet reports required a lot hours of manual data entry.
...
| --- | --- | --- | --- | --- |
| delivery_next_day_3pl.ipynb | Automate data preprocessing to generate excel files based on 3PL | ETL: CSV → Clean → Excel | Files with xlsx format | Python (Pandas, NumPy, pytz, OpenPyXl) |
...
| delivery_sameday_3pl.ipynb | Automate data preprocessing to generate excel files based on time slots for same day delivery | ETL: CSV → Clean → Excel | Files with xlsx format | Python (pandas, numpy, pytz, openpyxl) |
