...
| --- | --- | --- | --- | --- |
| [delivery_next_day_3pl.ipynb]([url](https://github.com/adangkurnia/logistics-etl-scripts/blob/main/colab_notebooks/delivery_next_day_3pl.ipynb)) | Automate data preprocessing to generate excel files based on 3PL name | ETL: CSV → Clean → Excel | Files with xlsx format | Python (Pandas, NumPy, pytz, OpenPyXl) |
